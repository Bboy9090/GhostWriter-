...
const defaultTheme = {
  container: {
    center: true,
    padding: '2rem',
    // Only use dimension-based screens for container; exclude coarse/pwa (media features)
    screens: {
      sm: '640px',
      md: '768px',
      lg: '1024px',
  ...
  extend: {
    // Custom media - use via arbitrary: [@media_(pointer:coarse)]:min-h-11
    // Excluded from screens to avoid invalid container CSS (width >= pointer:coarse)
    screens: {},
    colors: {
      neutral: {
